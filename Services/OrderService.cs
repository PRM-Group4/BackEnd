...
namespace Services
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(IOrderRepos repos, IMapper mapper)
        {
            _repos = repos;
            _mapper = mapper;
        }

        public async Task<OrderRequest> Create(OrderRequest data)
        {
            try
            {
                var map = _mapper.Map<Order>(data);
                var dataCreate = await _repos.Create(map);
                var resutl = _mapper.Map<OrderRequest>(dataCreate);
                return resutl;
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<OrderRequest>> GetAll()
        {
            try
            {
                ...
                var map = _mapper.Map<List<OrderRequest>>(data);
                return map;
        ...
        public async Task<bool> Update(int id, OrderRequest data)
        {
            try
            {
