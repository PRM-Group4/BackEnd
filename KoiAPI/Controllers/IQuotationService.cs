...
namespace KoiAPI.Controllers
{
    ...
    [ApiController]
    public class QuotationService : ODataController
    {
        private readonly IQuotationService _service;

        public QuotationService(IQuotationService service)
        {
            _service = service;
        }
        ...
        [HttpPut("update")]
        public async Task<IActionResult> UpdateQuotation(int id, QuotationRequest dto)
        {
            try
            {
        ...
        //[Authorize(Roles = "Staff")]
        [HttpPost("create")]
        public async Task<IActionResult> CreateQuotation(QuotationRequest dto)
        {
            try
            {
