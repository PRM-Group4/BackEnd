...
namespace KoiAPI.Controllers
{
    ...
    public class FeedbackController : ODataController
    {
        ...
        public FeedbackController(IKoiTypeService service)
        {
            _service = service;
        }
        ...
        [HttpPut("update")]
        public async Task<IActionResult> UpdateKoiType(int id, KoiTypeRequest dto)
        {
            try
            {
        ...
        //[Authorize(Roles = "Staff")]
        [HttpPost("create")]
        public async Task<IActionResult> CreateKoiType(KoiTypeRequest dto)
        {
            try
            {
        ...
        //[Authorize(Roles = "Staff")]
        [HttpDelete("delete")]
        public async Task<IActionResult> DeleteKoiType(int id)
        {
            try
            {
        ...
        //[Authorize(Roles = "Staff")]
        [HttpGet]
        public async Task<IActionResult> GetAllKoiType()
        {
            try
            {
        ...
        //[Authorize(Roles = "Staff")]
        [HttpGet("get-by-id")]
        public async Task<IActionResult> GetKoiTypeById(int id)
        {
            try
            {
