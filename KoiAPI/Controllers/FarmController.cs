...
namespace KoiAPI.Controllers
{
    ...
    [ApiController]
    public class FarmController : ODataController
    {
        ...
        [HttpPut("update")]
        public async Task<IActionResult> UpdateFarm(int id, FarmRequest dto)
        {
            try
            {
        ...
        //[Authorize(Roles = "Staff")]
        [HttpPost("create")]
        public async Task<IActionResult> CreateFarm(FarmRequest dto)
        {
            try
            {
        ...
        //[Authorize(Roles = "Staff")]
        [HttpGet]
        public async Task<IActionResult> GetAllFarm()
        {
            try
            {
